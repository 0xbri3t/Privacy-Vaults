...
import { handleHealth, handleShieldSession, handleLoanInfo, handleFeeInfo, handleVaultCommitments, handleYieldIndex, handleVaultStats, handleFaucetClaim } from "./routes.js";
